...
typedef UINT_PTR (*NSISPLUGINCALLBACKEX)(UINT_PTR, enum NSPIMEX, UINT_PTR);
...
typedef struct
{
    ...
    int(NSISCALL * RegisterPluginCallbackEx)(HMODULE, NSISPLUGINCALLBACK, NSISPLUGINCALLBACKEX, UINT_PTR);
} extra_parameters;
